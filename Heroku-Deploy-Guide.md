...
- 🎵️ Music 🎵️
- 💫 Chill 💫
1. [Chitoge](https://github.com/BEYOND-THE-WORLD/lumine-) - Go there
...
`CHAT_BOT_URL` A BOT WITH A BRAIN ROCKS! Click=> [Get ChatBot Url](https://github.com/BEYOND-THE-WORLD/Lumine-guides/blob/main/Chat_Bot_Url.md)<br>
...
`MONGO_URI` is the Connection URL to your DB ([Mongo-Atlas-Guide](https://github.com/BEYOND-THE-WORLD/Lumine-guides/blob/main/Mongo-Atlas-guide.md))<br>
